...
public class ProgramPanelGUI extends JPanel implements MouseListener {
    ...
    Semafor semafor;
    Rectangle buttonRect = new Rectangle(900, 300, 100, 20);
    Rectangle buttonRect1 = new Rectangle(400, 700, 100, 20);
    Rectangle buttonRect2 = new Rectangle(900, 700, 100, 20);
    Rectangle buttonRect3 = new Rectangle(400, 300, 100, 20);
